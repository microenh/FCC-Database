...
sqlite3 fcc3.sqlite 'create table AM
(
...
sqlite3 fcc3.sqlite 'create table EN
(
      record_type               char(2)              not null,
      unique_system_identifier  numeric(9,0)         not null primary key,
...
sqlite3 fcc3.sqlite 'create table HD
(
      record_type                  char(2)              not null,
      unique_system_identifier     numeric(9,0)         not null primary key,
      uls_file_number              char(14)             null,
...
sqlite3 fcc3.sqlite 'create table lookup (
...
sqlite3 fcc3.sqlite '.import l_amat/HD.dat HD'
sqlite3 fcc3.sqlite '.import l_amat/AM.dat AM'
sqlite3 fcc3.sqlite '.import l_amat/EN.dat EN'

sqlite3 fcc3.sqlite 'insert into lookup
select
...
sqlite3 fcc3.sqlite 'create index callsign on lookup(callsign)'

sqlite3 fcc3.sqlite 'drop table EN'
sqlite3 fcc3.sqlite 'drop table AM'
sqlite3 fcc3.sqlite 'drop table HD'

sqlite3 fcc3.sqlite 'create table counts (line text)'


sqlite3 fcc3.sqlite '.import l_amat/counts counts'

sqlite3 fcc3.sqlite 'create table db_date (date text)'


sqlite3 fcc3.sqlite 'insert into db_date select substr(line, 21, 99) from counts limit 1'

sqlite3 fcc3.sqlite 'drop table counts'

sqlite3 fcc3.sqlite 'VACUUM'
